...
<div class="container">
	<div class="d-flex justify-content-center h-100">
		<div class="card">
			...
			<div class="card-body">
				<form action="./logic/LogicRegister.php" method="post">
					...
					<div class="input-group form-group">
						...
						<input type="password" class="form-control" placeholder="Nhập Lại Mật Khẩu" name="confirm_password" id="confirm_password">
							...
							<span  id="message" style="transform:translateY(10px);"></span>
					...
					<div class="form-group">
						<input type="submit" value="Đăng Ký" class="btn float-right login_btn" name="submit">
					</div>
				</form>  
...
$('#password, #confirm_password').on('keyup', function () {
  if ($('#password').val() == $('#confirm_password').val()) {
    $('#message').html('Nhập lại mật khẩu đúng').css('color', 'chartreuse');
  } else 
    $('#message').html('Nhập lại mật khẩu sai').css('color', 'red');
});
