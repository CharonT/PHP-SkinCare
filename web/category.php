					...
					<div class="row">
						<div class="col-lg-12">
							<div class="hero-nav-area">
								...
								<p class="text-white link-nav"><a href="index.php">Home </a>  <span class="lnr lnr-arrow-right"></span><a href="category.php">Posts Category</a></p>
							</div>
						</div>
						<div class="col-lg-12">
									...
									<div class="editors-pick-post">
										...
										<div class="post-lists">
											<div class="single-post d-flex flex-row">
												...
												<div class="detail">
													<a href="detail.php"><h6>Help Finding Information
											...
											<div class="single-post d-flex flex-row">
												...
												<div class="detail">
													<a href="detail.php"><h6>Compatible Inkjet Cartr
													world famous</h6></a>
													<ul class="meta">
														<li><a href="#"><span class="lnr lnr-calendar-full"></span>03 April, 2018</a></li>
														<li><a href="#"><span class="lnr lnr-bubble"></span>06</a></li>
											...
											<div class="single-post d-flex flex-row">
												...
												<div class="detail">
													<a href="detail.php"><h6>5 Tips For Offshore Soft
													Development </h6></a>
													<ul class="meta">
														<li><a href="#"><span class="lnr lnr-calendar-full"></span>03 April, 2018</a></li>
														<li><a href="#"><span class="lnr lnr-bubble"></span>06</a></li>
